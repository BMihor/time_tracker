    ...
    var L = function (h) {
        var j = function (e) {
            ...
            function pa(a) {
                ...
                !a.sEmptyTable && (a.sZeroRecords && "Данные отсутствуют в таблице" === b.sEmptyTable) && p(a, a, "sZeroRecords", "sEmptyTable");
                !a.sLoadingRecords &&
        ...
        j.defaults = {
            ...
            oLanguage: {
                ...
                sInfo: "Показан с _START_ по _END_ из _TOTAL_ записей",
                sInfoEmpty: "Показан с 0 по 0 из 0 записей",
